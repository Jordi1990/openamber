...
class OpenthermSlaveHub : public Component {
 public:
  ...
  void set_ch_enable_binary_sensor(binary_sensor::BinarySensor *s) { this->ch_enable_sensor_ = s; }
  void set_dhw_enable_binary_sensor(binary_sensor::BinarySensor *s) { this->dhw_enable_sensor_ = s; }
  void set_cooling_enable_binary_sensor(binary_sensor::BinarySensor *s) { this->cooling_enable_sensor_ = s; }
 ...
 protected:
  ...
  binary_sensor::BinarySensor *ch_enable_sensor_{nullptr};
  binary_sensor::BinarySensor *dhw_enable_sensor_{nullptr};
  binary_sensor::BinarySensor *cooling_enable_sensor_{nullptr};
