...
- 3D printed models:
  - [OpenAmber Screen Bracket Part 1.stl](docs/OpenAmber_Screen_Bracket_Part1.stl)
  - [OpenAmber Screen Bracket Part 2.stl](docs/OpenAmber_Screen_Bracket_Part2.stl)
- 4x M2.5x10mm screws
...
![Overview](docs/images/BracketAssembly.jpeg)
...
![Part1Bottom](docs/images/BracketPart1_BOTTOM.jpeg)
...
![Part1Top](docs/images/BracketPart1_TOP.jpeg)
...
![Part2Back](docs/images/BracketAssemblyMounted_BACK.jpeg)

## Result
The completed integration!
![Part2Front](docs/images/BracketAssemblyMounted_FRONT.jpeg)
